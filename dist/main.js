...
/* harmony export */   "indexOfProject": () => (/* binding */ indexOfProject),
/* harmony export */   "newProject": () => (/* binding */ newProject),
/* harmony export */   "updateProjects": () => (/* binding */ updateProjects),
/* harmony export */   "updateProjectsFromTasks": () => (/* binding */ updateProjectsFromTasks)
/* harmony export */ });
...
/* harmony export */   "displayEditForm": () => (/* binding */ displayEditForm),
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _assets_todo_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/todo.svg */ "./src/assets/todo.svg");
...
function setHeader() {
  ...
  headLogo.src = _assets_todo_svg__WEBPACK_IMPORTED_MODULE_0__;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (navTree);
...
function getTasks(filter) {
  if (localStorage.getItem("tasks") !== null) {
    ...
    switch (filter) {
      ...
      case "thisWeek":
        for (let i = 0; i < tasks.length; i++) {
          let weekFromNow = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 7);
          let yesterDay = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), -1);
          let tempDate = tasks[i].dueDate.split("-");
          if (
...
module.exports = __webpack_require__.p + "todo.svg";
...
/* harmony import */ var _navTree_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./navTree.js */ "./src/navTree.js");
...
/* harmony import */ var _taskView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./taskView */ "./src/taskView.js");
...
(0,_navTree_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
addTaskCancel.addEventListener("click", _addTask_js__WEBPACK_IMPORTED_MODULE_3__.clearTaskForm);

const newProjectBtn = document.getElementById("newProject");
newProjectBtn.addEventListener("click", _addProject_js__WEBPACK_IMPORTED_MODULE_4__.displayProjectForm);
...
projectCancelBtn.addEventListener("click", _addProject_js__WEBPACK_IMPORTED_MODULE_4__.clearProjectForm);

if (localStorage.getItem("tasks") !== null) {
  (0,_addProject_js__WEBPACK_IMPORTED_MODULE_4__.updateProjectsFromTasks)();
  let toDisplay = (0,_taskView__WEBPACK_IMPORTED_MODULE_5__.getTasks)("home");
  document.getElementById("tasks").innerHTML = (0,_taskView__WEBPACK_IMPORTED_MODULE_5__.displayTasks)(toDisplay);
  (0,_taskView__WEBPACK_IMPORTED_MODULE_5__.setPriorities)(toDisplay);
...
function newTaskProcess() {
  (0,_addTask_js__WEBPACK_IMPORTED_MODULE_3__.displayTaskForm)();
  const addTaskSubmit = document.getElementById("addTaskSubmit");
  addTaskSubmit.addEventListener("click", assignTask);
}

function assignTask(e) {
  let task = (0,_addTask_js__WEBPACK_IMPORTED_MODULE_3__.addTask)();
  if (task !== null) {
    (0,_addTask_js__WEBPACK_IMPORTED_MODULE_3__.newTask)(task);
    (0,_addProject_js__WEBPACK_IMPORTED_MODULE_4__.newProject)(task.project);
    (0,_addProject_js__WEBPACK_IMPORTED_MODULE_4__.updateProjects)();
    updateListEventListener();
...
function projectFormValidation() {
  ...
  if (project.value.trim() !== "") {
    (0,_addProject_js__WEBPACK_IMPORTED_MODULE_4__.newProject)(project.value);
    (0,_addProject_js__WEBPACK_IMPORTED_MODULE_4__.updateProjects)();
    updateListEventListener();
    (0,_addProject_js__WEBPACK_IMPORTED_MODULE_4__.clearProjectForm)();
  }
}
...
function displayProjectSet(e) {
  let toDisplay = (0,_taskView__WEBPACK_IMPORTED_MODULE_5__.getTasks)(e.target.id);
...
function editTask(e) {
  ...
  taskId = taskId.replace("task", "");
  taskId = taskId[0];
  let taskToEdit = (0,_taskView__WEBPACK_IMPORTED_MODULE_5__.getTaskToEdit)(taskId);
  (0,_addTask_js__WEBPACK_IMPORTED_MODULE_3__.displayEditForm)(taskToEdit);
...
function updateTask(e) {
  ...
  let newInfo = (0,_addTask_js__WEBPACK_IMPORTED_MODULE_3__.addTask)();
